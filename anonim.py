...
#     header = data[:8]
#     if header != b'\x89PNG\r\n\x1a\n':
#         raise ValueError("This is not a PNG file")
#
#     metadata_offsets = []
...
#
#     # Parsuj chunki
#     pos = 8  # Pozycja, od której zaczynamy czytać chunki
#     while pos < len(data):
#         length = int.from_bytes(data[pos:pos+4], byteorder='big')
#         chunk_type = data[pos+4:pos+8]
#
#         if chunk_type not in {b'IHDR', b'PLTE', b'tEXt', b'iTXt'}:
#             # Jeśli nie jest to metadane i długość jest większa niż 0, zachowaj offset i długość chunka
#             if length > 0:
#                 metadata_offsets.append((pos, length))
#                 # Dodaj chunk do oczyszczonego pliku
#                 cleaned_data += data[pos:pos+length+12]
#
#         # Przesuń pozycję do następnego chunka
#         pos += length + 12
#
#     # Zapisz oczyszczony plik PNG
...
#
# # Przykład użycia
# metadata_offsets = remove_metadata("example6.png", "output_ex6.png")
#
# # Wyświetl znalezione offsety sekcji niebędących metadanymi
# print("Metadata offsets:", metadata_offsets)
#
# input_file = "example6.png"
# output_file = "output_ex6.png"
#
# input_size = os.path.getsize(input_file)
# output_size = os.path.getsize(output_file)
#
# print("Rozmiar pliku wejściowego:", input_size, "bajtów")
# print("Rozmiar pliku wyjściowego:", output_size, "bajtów")
#
# # Sprawdź, czy plik PNG został utworzony poprawnie
# try:
#     img = Image.open(output_file)
#     img.show()  # Otwiera obraz za pomocą domyślnego programu do przeglądania obrazów
